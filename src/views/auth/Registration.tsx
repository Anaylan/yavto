					...
					<div className='fv-row mb-5'>
						...
						<input
							...
							className={clsx(
								...
								{
									"is-invalid":
										formik.touched.dir_name && formik.errors.dir_name,
								},
								{
									"is-valid":
										formik.touched.dir_name && !formik.errors.dir_name,
						...
						{formik.touched.dir_name && formik.errors.dir_name && (
							<div className='fv-plugins-message-container'>
								<div className='fv-help-block'>
									<span role='alert'>{formik.errors.dir_name}</span>
								</div>
							</div>
						)}
					</div>
			...
			<div className='fv-row mb-10'>
				<div className='form-check form-check-custom form-check-solid'>
					...
					<label
						...
						I Agree the{" "}
						<Link to={`${ROOT_URL}/auth/terms`} className='ms-1 link-primary'>
